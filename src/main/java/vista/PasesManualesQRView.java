...
public class PasesManualesQRView extends JPanel {
    ...
    private JPanel buildContent() {
        ...
        personsTab.addActionListener(e -> showCard("persons"));
        vehiclesTab.addActionListener(e -> showCard("vehicles"));
        objectsTab.addActionListener(e -> showCard("objects"));
        personsTab.addActionListener(e -> setActive(personsTab));
        vehiclesTab.addActionListener(e -> setActive(vehiclesTab));
        objectsTab.addActionListener(e -> setActive(objectsTab));
    ...
    private JPanel leftVisitorForm() {
        ...
        card.add(textField("Nombre Completo"));
        card.add(Box.createVerticalStrut(12));
        card.add(textField("Documento"));
        card.add(Box.createVerticalStrut(12));
        card.add(textField("Entidad/Empresa"));
        card.add(Box.createVerticalStrut(18));
        card.add(new PillButton("Generar Pase QR", new Color(62, 170, 0), 170));
        return card;
    }
    ...
    private JPanel leftVehicleForm() {
        ...
        card.add(textField("Placa"));
        card.add(Box.createVerticalStrut(12));
        card.add(comboField("Selecciona Tipo", "Carro", "Moto", "Camión"));
        card.add(Box.createVerticalStrut(12));
        card.add(textField("Propietario / Conductor"));
        card.add(Box.createVerticalStrut(12));
        card.add(textArea("Motivo de Ingreso"));
        card.add(Box.createVerticalStrut(18));
        card.add(new PillButton("+ Registrar y Generar QR", new Color(62, 170, 0), 170));
        return card;
    }
    ...
    private JPanel leftObjectForm() {
        ...
        card.setBorder(new EmptyBorder(18, 18, 18, 18));
        card.setPreferredSize(new Dimension(230, 332));
        card.add(textArea("Descripción del Objeto (ej. Portátil, Taladro)"));
        card.add(Box.createVerticalStrut(12));
        card.add(textField("Serial / Placa de Control (Opcional)"));
        card.add(Box.createVerticalStrut(12));
        card.add(textField("Propietario / Portador"));
        card.add(Box.createVerticalStrut(12));
        card.add(textArea("Motivo de Ingreso"));
        card.add(Box.createVerticalStrut(18));
        card.add(new PillButton("+ Registrar y Generar QR", new Color(62, 170, 0), 170));
    ...
    private JPanel rightTable(String titleText, String col1, String col2) {
        ...
        JPanel table = new JPanel(new GridLayout(0, 3));
